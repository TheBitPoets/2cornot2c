...
| 29 | Intermedio | UDA 9: file | `FILE*`, apertura, lettura, scrittura. | Gestione errori I/O. | Lab C/E: programma con file di dati. | [I/O sui file](../README.md#semplici-operazioni-di-io-sui-file), [creare file](../README.md#creare-ed-aprire-i-file), [leggere file](../README.md#leggere-testo-dai-file-con-fgets), [scrivere file](../README.md#scrivere-testo-su-file-con-fprintf) | Lo studente salva e rilegge dati persistenti. |
| 30 | Intermedio | UDA 9: Makefile | Target, dipendenze, build incrementale. | Compilazione multi-file automatizzata. | Lab C: Makefile per progetto esistente. | [Processo di compilazione](../README.md#il-processo-di-compilazione), [moduli](../README.md#suddivisione-in-moduli-di-un-programma) | Lo studente automatizza la build. |
...
| 3 | Avanzato | UDA 10: gestione errori | Codici di ritorno, `errno`, cleanup. | Errori recuperabili e non recuperabili. | Lab F: aggiungere gestione errori. | [File](../README.md#semplici-operazioni-di-io-sui-file), [allocazione dinamica](../README.md#allocazione-dinamica-della-memoria) | Lo studente gestisce fallimenti espliciti. |
| 4 | Avanzato | UDA 10: logging e test | Output utente, stderr, log. | Test, casi limite, regressioni. | Lab F: testare un modulo. | [printf](../README.md#testo-formattato-con-printf), [output automatici](LAB_OUTPUTS.md) | Lo studente distingue comportamento e diagnostica. |
...
| 27 | Avanzato | UDA 15: I/O e processi | File descriptor e I/O. | Collegamento con processi e pipe. | Lab C: pipeline minimale. | [Semplici operazioni di I/O sui file](../README.md#semplici-operazioni-di-io-sui-file), [processi](../LINUX_PROGRAMMING.md#processi) | Lo studente collega I/O e processi. |
...
| 31 | Avanzato | UDA 16: manutenzione | Coding standard, refactoring. | Commenti utili e documentazione. | Lab F: review di codice. | [Moduli](../README.md#suddivisione-in-moduli-di-un-programma), [manutenibilita e riutilizzo](../README.md#manutenibilità-e-riutilizzo) | Lo studente rende il codice piu leggibile. |
...
| UDA 9 | Intermedio | 29-33 | File, Makefile, debugging, strumenti e progetto. | [I/O sui file](../README.md#semplici-operazioni-di-io-sui-file), [output automatici](LAB_OUTPUTS.md), [snippet lab](LAB_SNIPPETS.md) | Lab con file, `make`, debug, ASan/Valgrind, mini-progetto finale. |
