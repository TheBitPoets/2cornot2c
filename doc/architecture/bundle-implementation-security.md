...
- Anche i file in `materials/` devono passare una whitelist MIME esplicita. Nel pilota HTML, SVG e altri formati browser-attivi sono rifiutati; sono ammessi Markdown/testo, PDF e immagini raster note (PNG/JPEG/WebP).
