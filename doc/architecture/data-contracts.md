...
3. Usare questi contratti per disegnare la valutazione SQLite/storage senza migrare subito. Vedi [`storage-sqlite-evaluation.md`](storage-sqlite-evaluation.md).
